---
title: "Homework5. Matrices, lists, and data frames"
...
typeof(n_dims)
print(n_dims)
#Creates a new vector between 1 and the ramdom generated number from before
new_vec<-(1:(n_dims^2))
print(new_vec)
#Reshuffles las vector
sample(x=new_vec)
#Create a matrix with the last vect. Is a square matrix, becouse nrow=n_dims
...
typeof(new_vector) #Its a character
print(new_vector)
```
...
#Will create a new data frame replacing the variable my_unis to the same variable replacing for random numbers to NA
...
#Print the mean of my_unis of the data frame my_df, omiting NA values. 
