...
This is the link for Homework 9, Structure Programming: [Link](Homework9.html). You could also find the function [here](Homework9_Functions.html)

This is the link for Homework 10, For Loops and Randomization : [Link](Homework10.html). You can find the functions in [here](Function10.html)

This is the link for Homework 11, Batch Processing: [Link](NEON_count-landbird/Homework11.html).

This is the link for Homework 12, Playing with GGPLOT: [Link](Homework12.html).
