...
Again, is very similar: ```(\w{3})\w+,(\w{3})\w+,(\d*\.\d),(\d*)```. The main chain is to just select the fist 3 letter of each word: ```(\w{3})\w+,(\w{3})\w+,```. Lastly, just replace with: ```\1\2, \4, \3```. This will join the to first characters, located the 4th separated by a comma, and the theird at the end, also separated by a comma. 
